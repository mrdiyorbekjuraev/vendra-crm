...
import { KeyRound, PenLine, Phone } from "lucide-react";
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            <Button
              className="w-full"
              type="submit"
              disabled={isPending || Boolean(phoneForm?.errors?.phoneNumber)}
            >
        ...
        >
          <motion.div className="w-full relative" variants={itemVariants}>
            <div className="text-xs text-muted-foreground text-center">
              <span>Enter the code associated with your account</span>

...
export const Header = () => {
  ...
  const handleSubmit = async () => {
    await handleRolePermissionAssignee.mutateAsync({
      ...
      permissions: role?.data?.permissions?.map((el: any) => {
        return {
          ...
          {role?.data?.updateAt && (
            <div className="text-sm text-muted-foreground">
              ...
              <span className="font-medium text-primary">
                {formatDate(String(role?.data?.updateAt), lang)}
              </span>
            </div>
          )}
      ...
      <div className="flex items-center py-2 bg-muted/40 border-b px-3 gap-2">
        <div className="flex items-center gap-2 w-full">
          ...
          <DropdownMenu>
            ...
            >
              <DropdownMenuItem
                className="w-full dark:hover:bg-sidebar-accent"
              ...
              <DropdownMenuItem
                ...
                className="dark:hover:bg-sidebar-accent"
              >
                <div className="flex items-center justify-between w-full">
                  <Badge
